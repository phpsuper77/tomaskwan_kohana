    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                <a href="<?=PATH;?>staff/list"><?= __('MENU_STAFF') ?></a>
                </li>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption caption-md margin-right-10">
                                ...
                                <span class="caption-subject theme-font-color bold uppercase"><?= __('INFO_STAFF') ?></span>
                            </div>

                            <div class="actions">
                                <a href="#" class="btn btn-circle btn-default btn-sm" data-toggle="modal" data-target="#addStaffModal">
                                    <i class="fa fa-user"></i> <?=__('ASSOCIATE_STAFF')?></a>
                        ...
                        <div class="portlet-body" style="height: auto;">
                            <div class="table-scrollable table-scrollable-borderless">
                                <table id="ajax-table" class="table table-hover table-light" data-jsbase="<?=JS;?>" data-url="<?= PATH;?>staff/list_ajax" data-src="profile" data-page="1" data-order="desc" data-sort="id">
                                    <thead>
