    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                <a href="<?= PATH;?>review/list"><?= __('MENU_REVIEWS') ?></a>
                </li>
            </ul>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption caption-md margin-right-10">
                                ...
                                <span class="caption-subject theme-font-color bold uppercase"><?= __("INFO_REVIEWS") ?></span>
                            </div>
                        ...
                        <div class="portlet-body" style="height: auto;">
                            <div class="table-scrollable table-scrollable-borderless">
                                <table id="ajax-table" class="table table-hover table-light" data-jsbase="<?=JS;?>" data-url="<?= PATH;?>review/list_ajax" data-page="1" data-order="desc" data-sort="id">
                                    <thead>
