                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption caption-md margin-right-10">
                                ...
                                <span class="caption-subject theme-font-color bold uppercase"><?= __("INFO_MY_OFFERS") ?></span>
                            </div>
...
-->
                        ...
                        <div class="portlet-body" style="height: auto;">
                            <div class="table-scrollable table-scrollable-borderless">
                                <table id="ajax-table" class="table table-hover table-light" data-jsbase="<?=JS;?>" data-url="<?= PATH;?>myoffer/list_ajax" data-src="profile" data-page="1" data-order="desc" data-sort="id">
                                    <thead>
                                        <tr class="uppercase no-hover">
                                            ...
                                            <th class="sorting" data-order="asc" data-sort="order_id"><?=__('ORDER')?></th>
                                            <th>ACTION</th>
                                        </tr>
                                    </thead>
                                    <tbody class="list">
