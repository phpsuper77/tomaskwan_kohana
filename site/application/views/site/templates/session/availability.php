                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body" style="height: auto;">
                            ...
                            <form action="<?= PATH;?>session/setting" method="post">
                                ...
                                <table class="table table-light table-hover">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
<? if ($settingObj->getAttr('enabled') == 1): ?>
...
<? endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" name="session">
                                                    <option value="1800" <?= $settingObj->getSession()==1800 ? 'selected="selected"' : '';?>>30 minuts</option>
                                                    <option value="2700" <?= $settingObj->getSession()==2700 ? 'selected="selected"' : '';?>>45 minuts</option>
                                                    <option value="3600" <?= $settingObj->getSession()==3600 ? 'selected="selected"' : '';?>>60 minuts</option>
                                                    <option value="5400" <?= $settingObj->getSession()==5400 ? 'selected="selected"' : '';?>>90 minuts</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td><input class="form-control" type="text" name="price" value="<?= $settingObj->getAttr('price') ?>"></td>
                                        </tr>
                                        <tr>
                                            <td style="width:25%;">Location</td>
                                            <td></td>
                                            <td><input class="form-control" type="text" name="room" value="<?= $settingObj->getAttr('room') ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Availability</td>
                                            <td colspan="2">
          ...
          <? $time = $modelSettings->getTime($loginUserObj->getId(),$i);  ?>
                                        ...
                                        <tr>
                                            <td>Exclude Dates</td>
                                            <td></td>
                                            <td><input class="form-control" type="text" placeholder="Example: 11/28/2015, 12/26/2015" name="excluded_dates" value="<?= $settingObj->getAttr('excluded_dates') ?>"></td>
                                        </tr>
                                    </tbody>
                                </table>
