...
class Controller_Site_Review extends Controller_Site_Private
{
    ...
    public function action_list()
    {
        ...
        $this->template->content = View::factory('site/templates/review/list');
        $this->template->content->reviewModal = View::factory('site/templates/review/modal');
    ...
    public function action_list_ajax()
    {
        if(isset($_POST['sort']))
        {
            ...
            $this->template = View::factory('site/templates/review/list_ajax');
    ...
    public function action_cancel()
    {
        ...
        Stats::track($this->loginUserObj->getId(), 'review.cancel', array('id'=>$id));
        $this->request->redirect('/review/list');
    }
}
